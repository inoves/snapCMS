...
class ApplicationController // extends SnapClass
{
	...
	function config_app(){
		...
		$this->view->cart = Session::get('cart');//$SESSION['cart'];
		...
		//$this->view->xml = simplexml_load_file('http://services.sapo.pt/Captcha/Get');
		$this->view->xml = new stdClass();
		Session::set('captcha', $this->view->xml->code);
		//Captcha service sapo
	}
}
?>